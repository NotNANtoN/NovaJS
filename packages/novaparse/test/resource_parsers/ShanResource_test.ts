...
describe("ShanResource", () => {
    ...
    it("should parse baseImage maskID", () => {
    ...
    it("should parse baseImage setCount", () => {
    ...
    it("should parse baseImage size", () => {
    ...
    it("should parse baseImage.transparency", () => {
    ...
    it("should parse glowImage maskID", () => {
    ...
    /*
      it("should parse glowImage setCount", () => {
    ...
    */
    it("should parse glowImage size", () => {
    ...
    */
    ...
    it("should parse weapImage maskID", () => {
        expect(thunderforge.images.weapImage!.maskID).toEqual(1931);
    });
    /*
      it("should parse weapImage setCount", () => {
    ...
    */
    it("should parse weapImage size", () => {
    ...
    // it("should parse shieldImage maskID", () => {
    ...
    // });
    /*
      it("should parse shieldImage setCount", () => {
    ...
    */
    // it("should parse shieldImage size", () => {
